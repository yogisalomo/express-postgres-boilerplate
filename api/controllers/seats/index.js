...
const service = __importStar(require("../../services/seat_service"));
const mapper = __importStar(require("./mapper"));
const getByAuditoriumId = (auditoriumId) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield service.getByAuditoriumId(auditoriumId)).map(mapper.dbToModel);
});
...
const getUnavailableSeats = (auditoriumId, numbers) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield service.getUnavailableSeats(auditoriumId, numbers)).map(mapper.dbToModel);
});
...
const updateAvailabilityByNumber = (updatedAvailability, numbers) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield service.updateAvailabilityByNumber(updatedAvailability, numbers);
    return result[0];
});
