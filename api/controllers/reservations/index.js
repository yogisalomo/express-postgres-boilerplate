...
const service = __importStar(require("../../services/reservation_service"));
const mapper = __importStar(require("./mapper"));
const getByCode = (code) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield service.getByCode(code);
    if (result) {
...
const releaseCheckout = (code) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield service.releaseCheckout(code);
    console.log(result);
    return result[0];
});
